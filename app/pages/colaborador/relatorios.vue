...
const baseLogs = [
  ...
  },
  {
    ...
    actionColor: 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300',
    details: 'Atualizou o progresso da tarefa "Otimizar consultas" para 80%',
  ...
  },
  {
    ...
    action: 'Status Atualizado',
    actionColor: 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300',
    details: 'Iniciou o desenvolvimento da tarefa "Corrigir cálculo de frete"',
...
// Duplicate mock logs list to showcase the functional "items per page" select
const logs = [
  ...baseLogs,
  ...
  <div class="space-y-5 p-4 sm:p-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      ...
      <div class="flex items-center gap-3">
        ...
        <USelect v-model="perPage" :items="[5, 10, 15, 20]" class="w-18 bg-white" />
