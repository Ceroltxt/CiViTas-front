  ...
  <div class="space-y-5 p-4 sm:p-6">
    ...
    <div class="flex flex-wrap items-start justify-between gap-3">
      <div>
        ...
        <p class="text-sm text-slate-400">Acompanhe o andamento das tarefas e dos projetos da organização</p>
      </div>
        ...
        <template #content>
          <ul class="max-h-64 w-72 overflow-y-auto scroll-thin py-1">
            <li v-for="p in projects" :key="p.id">
              ...
              >
                <span class="size-2.5 shrink-0 rounded-full" :class="p.color || 'bg-violet-500'" />
