...
<template>
  <div class="space-y-5 p-4 sm:p-6 dark:bg-slate-900 min-h-screen">
    ...
    <div class="flex flex-wrap items-center gap-3">
      ...
      <UiLabeledSelect v-model="priorityFilter" label="Prioridade:" :items="['Todas']" class="w-40" />
      <UInput
        v-model="search"
    ...
    <!-- Conteúdo da aba -->
    <QuadrosKanbanBoard v-if="activeTab === 'kanban'" />
    <QuadrosGanttChart v-else-if="activeTab === 'timeline'" />
  </div>
</template>
