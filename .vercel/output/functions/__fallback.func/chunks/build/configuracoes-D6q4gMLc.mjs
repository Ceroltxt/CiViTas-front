...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-3xl space-y-5 p-4 sm:p-6" }, _attrs))}><div><h1 class="font-display text-2xl font-bold text-slate-800 dark:text-slate-100">Configurações</h1><p class="text-sm text-slate-400">Gerencie sua conta e preferências</p></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/gestor/configuracoes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=configuracoes-D6q4gMLc.mjs.map
