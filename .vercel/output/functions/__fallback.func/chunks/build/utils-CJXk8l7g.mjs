import { x as injectConfigProviderContext, R as useForwardExpose, t as getActiveElement, A as AUTOFOCUS_ON_MOUNT, o as focusFirst$1, v as getTabbableCandidates, n as focus, a as AUTOFOCUS_ON_UNMOUNT, b as Primitive, B as isNullish, E as EVENT_OPTIONS, w as getTabbableEdges } from './server.mjs';
import { computed, watch, ref, nextTick, defineComponent, watchEffect, openBlock, createBlock, unref, withCtx, renderSlot, normalizeStyle, reactive, toValue } from 'vue';
import { unrefElement, createSharedComposable, useEventListener, onKeyStroke, createGlobalState } from '@vueuse/core';
...
export { DismissableLayer_default as D, FIRST_LAST_KEYS as F, ITEM_SELECT as I, LAST_KEYS as L, SELECTION_KEYS as S, FocusScope_default as a, SUB_CLOSE_KEYS as b, SUB_OPEN_KEYS as c, getOpenState as d, isMouseEvent as e, focusFirst as f, getCheckedState as g, handleAndDispatchCustomEvent as h, isIndeterminate as i, isPointerInGraceArea as j, useHideOthers as k, useBodyScrollLock as u };
//# sourceMappingURL=utils-CJXk8l7g.mjs.map
