import { defineComponent, computed, openBlock, createElementBlock, normalizeStyle, unref, createVNode, mergeProps, withCtx, renderSlot, watchPostEffect, createBlock, ref, watchEffect, mergeDefaults } from 'vue';
import { isClient, refAutoReset } from '@vueuse/shared';
import { R as useForwardExpose, U as useForwardProps$1, N as useEmitAsProps, b as Primitive, k as createContext, t as getActiveElement } from './server.mjs';
...
export { PopperAnchor_default as P, PopperArrow_default as a, PopperContentPropsDefaultValue as b, PopperContent_default as c, PopperRoot_default as d, useForwardPropsEmits as e, useTypeahead as f, useFocusGuards as u };
//# sourceMappingURL=PopperArrow-C07et48U.mjs.map
