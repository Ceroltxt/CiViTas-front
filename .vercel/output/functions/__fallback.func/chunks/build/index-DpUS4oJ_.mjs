import { _ as _sfc_main$4 } from './Popover-Dn1k2Q3g.mjs';
import { d as _sfc_main$8 } from './server.mjs';
import { _ as _sfc_main$5 } from './Calendar-B3a-MegV.mjs';
import { _ as _sfc_main$6 } from './Modal-DrlsEEos.mjs';
import { _ as _sfc_main$7 } from './FileUpload-C6MmzP9v.mjs';
import { _ as _sfc_main$9 } from './Card-Bu3IYA97.mjs';
import { defineComponent, shallowRef, resolveComponent, mergeProps, withCtx, unref, createTextVNode, toDisplayString, createVNode, isRef, ref, useSSRContext } from 'vue';
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/chart/chartBarVertical.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const chartBarVertical = Object.assign(_sfc_main$3, { __name: "ChartBarVertical" });
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/chart/chartDonut.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const chartDonut = Object.assign(_sfc_main$2, { __name: "ChartDonut" });
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/chart/chartLine.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const chartLine = Object.assign(_sfc_main$1, { __name: "ChartLine" });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(chartBarVertical, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_Placeholder, { class: "h-24" }),
              createVNode(chartBarVertical)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_UCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Placeholder, { class: "h-24" }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(chartDonut, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_Placeholder, { class: "h-24" }),
              createVNode(chartDonut)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_UCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(chartLine, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_Placeholder, { class: "h-32" }),
              createVNode(chartLine)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-DpUS4oJ_.mjs.map
