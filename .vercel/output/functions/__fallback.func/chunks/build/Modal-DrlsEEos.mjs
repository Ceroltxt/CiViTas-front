import { defineComponent, ref, toRefs, renderSlot, unref, openBlock, createBlock, mergeProps, withCtx, normalizeProps, guardReactiveProps, createVNode, createCommentVNode, withModifiers, useSlots, toRef, computed, toHandlers, createTextVNode, toDisplayString, Fragment, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass } from 'vue/server-renderer';
import { R as useForwardExpose, b as Primitive, T as Teleport_default, P as Presence_default, N as useEmitAsProps, k as createContext, M as useComponentProps, X as useLocale, J as useAppConfig, S as useForwardProps, Y as usePortal, I as tv, V as VisuallyHidden_default, d as _sfc_main$8, F as FieldGroupReset } from './server.mjs';
import { useVModel, reactivePick, createReusableTemplate } from '@vueuse/core';
import { u as useBodyScrollLock, k as useHideOthers, a as FocusScope_default, D as DismissableLayer_default, d as getOpenState } from './utils-CJXk8l7g.mjs';
...
//# sourceMappingURL=Modal-DrlsEEos.mjs.map
